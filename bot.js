...
client.on('message', message => {
  ...
  if (message.author.id !== "337647196235366401") return;
...
if (message.content.startsWith(prefix + 'setT')) {
  client.user.setGame(argresult, "https://www.twitch.tv/blu4egam3r");
     console.log('test' + argresult);
...
client.on('ready', function(){
    ...
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`https://www.twitch.tv/blu4egam3r`);
    }, ms);100000
...
client.login("NDM5NDU1MDk3MDk3ODE0MDE3.XKXCIw.vpgOLK2vQXjc5lL0E2wD3-az6ng");
